            ...
            <li class="nav-item dropdown pe-3">
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    ...
                    if (isset($_SESSION['id_petugas'])) {
                        ...
                        if ($result && mysqli_num_rows($result) > 0) {
                            ...
                            if (!empty($petugas['fp'])) {
                                echo '<img src="../../assets_admin/img/fp_pengguna/petugas/' . $petugas['fp'] . '" alt="Profile" class="rounded-circle" />';
                            } else {
                                echo '<img src="../../assets_admin/img/user.png" alt="Profile" class="rounded-circle" />';
                            }
                            echo '<span class="d-none d-md-block dropdown-toggle ps-2">' . $petugas['nama_lengkap'] . '</span>';
                        }
                    }
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    <li class="dropdown-header">
                        <h6><?php echo $petugas['nama_lengkap'] ?? ''; ?></h6>
