...
if (empty($id_pimpinan) || empty($nama_lengkap) || empty($username) || empty($password)) {
...
$query_update = "UPDATE pimpinan SET nama_lengkap = '$nama_lengkap', username = '$username', password = '$password' WHERE id_pimpinan = '$id_pimpinan'";
