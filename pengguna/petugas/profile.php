...
<body translate="no">
    ...
    <main id="main" class="main">
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            ...
                            if (isset($_SESSION['id_petugas'])) {
                                ...
                                // Query SQL untuk mengambil data petugas berdasarkan id_petugas dari session
                                $query = "SELECT * FROM petugas WHERE id_petugas = '$id_petugas'";
                                $result = mysqli_query($koneksi, $query);

                                // Periksa apakah query berhasil dieksekusi
                                if ($result) {
                                    // Periksa apakah terdapat data petugas
                                    if (mysqli_num_rows($result) > 0) {
                                        // Ambil data petugas sebagai array asosiatif
                                        $petugas = mysqli_fetch_assoc($result);
                            ?>
                            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                <a href="javascript:void(0)"
                                    onclick="document.getElementById('editFotoProfile').click()">
                                    <?php if (!empty($petugas['fp'])): ?>
                                    <img src="../../assets_admin/img/fp_pengguna/petugas/<?php echo $petugas['fp']; ?>"
                                        alt="Profile" class="gbrr rounded-circle" />
                                    <?php else: ?>
                                    <img src="../../assets_admin/img/user.png" alt="ananddavis" class="img-fluid" />
                                    <?php endif; ?>
                                </a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editFotoProfileModalLabel">Edit Foto Profile
                                                </h5>
                                ...
                                <h2><?php echo $petugas['nama_lengkap']; ?></h2>
                                <h3><?php echo $petugas['username']; ?></h3>
                            </div>
                        </div>
                    </div>
                    <style>
                                ...
                                <div class="tab-content pt-2">
                                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-8"><?php echo $petugas['nama_lengkap']; ?></div>
                                        </div>

                                        <div class="row">
                                            <div class="col-lg-3 col-md-4 label">Lokasi Penempatan</div>
                                            <div class="col-lg-9 col-md-8">
                                                <?php echo $petugas['lokasi_penempatan']; ?>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-lg-3 col-md-4 label">Username</div>
                                            <div class="col-lg-9 col-md-8"><?php echo $petugas['username']; ?></div>
                                        </div>

                                        <div class="row">
                                            <div class="col-lg-3 col-md-4 label">Passweord</div>
                                            <div class="col-lg-9 col-md-8"><?php echo $petugas['password']; ?></div>
                                        </div>
                                    ...
                                    <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                        ...
                                        <form id="editProfileForm">
                                            <input type="text" name="id_petugas" id="id_petugas"
                                                value="<?php echo $petugas['id_petugas']; ?>" hidden>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="nama_lengkap" type="text" class="form-control"
                                                        id="nama_lengkap"
                                                        value="<?php echo $petugas['nama_lengkap']; ?>" />
                                                </div>
                                            </div>

                                            <div class="row mb-3">
                                                <label for="lokasi_penempatan"
                                                    class="col-md-4 col-lg-3 col-form-label">Lokasi Penempatan</label>
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="lokasi_penempatan" type="text" class="form-control"
                                                        id="lokasi_penempatan"
                                                        value="<?php echo $petugas['lokasi_penempatan']; ?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="username" type="text" class="form-control"
                                                        id="username" value="<?php echo $petugas['username']; ?>" />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="password"
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="password" type="text" class="form-control"
                                                        id="password" value="<?php echo $petugas['password']; ?>" />
                                                </div>
                                            </div>
        ...
        <?php
                                    ...
                                    echo "Gagal mengambil data petugas: " . mysqli_error($koneksi);
                                }
                            } else {
                                // Jika session id_petugas tidak diset
                                echo "Session id_petugas tidak tersedia.";
                            }
