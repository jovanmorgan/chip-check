...
<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <!-- Aktivasi -->
        <li class="nav-item">
            <a class="nav-link <?= ($current_page == 'aktivasi') ? '' : 'collapsed'; ?>" href="aktivasi">
        ...
        <!-- Transaksi -->
        <li class="nav-item">
            <a class="nav-link <?= ($current_page == 'transaksi') ? '' : 'collapsed'; ?>" href="transaksi">
        ...
        <!-- Cicle -->
        <li class="nav-item">
            <a class="nav-link <?= ($current_page == 'cicle') ? '' : 'collapsed'; ?>" href="cicle">
        ...
        <!-- Petugas -->
        <li class="nav-item">
            <a class="nav-link <?= ($current_page == 'petugas') ? '' : 'collapsed'; ?>" href="petugas">
                <i class="bi bi-people"></i>
                <span>Petugas Oprasional</span>
            </a>
        </li>
